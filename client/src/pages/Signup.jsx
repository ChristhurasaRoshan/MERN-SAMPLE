    ...
    return (
        <>
                ...
                <div className='fixed w-full px-4 pt-24 z-50'>
                    <div className='max-w-[450px] h-auto mx-auto bg-black/75 text-white rounded-3xl mt-10'>
                        <div className='max-w-[320px] mx-auto pt-16 pb-5'>
                            ...
                            <form onSubmit={handleSubmit} className='w-full flex flex-col py-4'>
                                ...
                                <p className='py-5 text-center'><span className='text-gray-400'>Already have an account? </span>{" "}
